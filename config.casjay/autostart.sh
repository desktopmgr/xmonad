...
# __cmd_exist ask_for_password && SUDO_ASKPASS="/usr/local/bin/ask_for_password"
# export SUDO_ASKPASS
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set desktop session
...
# export setting
export DESKTOP_SESSION DESKTOP_SESSION_CONFDIR RESOLUTION
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Start trayer
if __cmd_exist trayer; then
  __kill trayer
  __start trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x282c34 --height 22
fi

# Start emac daemon
if __cmd_exist emacs; then
  __kill emacs
  __start emacs --daemon
fi
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Wallpaper manager
